# 晨昏故人的个人生活主页 with RAG智能问答

一个集成了RAG智能问答功能的个人生活主页，展示个人兴趣爱好、最近动态的同时，提供基于个人数据的AI智能助手服务。

## 🎯 项目目标

帮助拓展社交圈，认识更多的朋友。通过展示个人的阅读、电影、音乐和运动爱好，让访问者更好地了解我。同时提供智能问答功能，让访客可以与基于我个人数据训练的AI助手对话，获得个性化的内容推荐。

## 🌟 项目特色

- **可爱卡通设计**: 清新的配色和圆润的设计元素
- **🤖 RAG智能问答**: 基于个人数据的AI助手，提供个性化对话和推荐
- **🔍 语义搜索**: 使用向量搜索技术，快速找到相关内容
- **📊 智能推荐**: 根据用户兴趣和心情，智能推荐书籍、电影、音乐
- **动态内容更新**: 定期更新书籍、电影、音乐等内容
- **响应式设计**: 适配桌面、平板和手机设备
- **双数据库架构**: MySQL + PostgreSQL，支持传统查询和向量搜索
- **易于维护**: API驱动，数据更新简单
...
│   ├── animations.css      # 动画效果
│   ├── chatbot.css         # 智能聊天机器人样式 🆕
│   └── README.md          # CSS说明文档
├── js/                     # JavaScript文件
│   ├── main.js            # 主要逻辑
│   ├── api.js             # 传统API调用模块
│   ├── rag-api.js         # RAG智能问答API模块 🆕
│   ├── chatbot.js         # 智能聊天机器人组件 🆕
│   ├── animations.js      # 动画控制
│   ├── music.js           # 音乐交互
│   ├── background.js      # 背景效果
│   ├── background-manager.js # 动态背景管理系统
│   ├── contact.js         # 联系功能
│   ├── details.js         # 详情弹窗
│   ├── school.js          # 学校信息弹窗
│   ├── qrcode.js          # 二维码弹窗功能
...
- **智能对话**: 点击右下角的"AI助手"按钮，与基于个人数据训练的AI进行对话
- **个性化回答**: AI助手了解我的阅读、观影、听歌偏好，能提供个性化的回答和推荐
- **语义理解**: 支持自然语言提问，无需使用特定关键词
...
- **智能对话**: 基于个人数据的AI助手，可以回答关于书籍、电影、音乐的问题
- **语义搜索**: 使用向量相似度搜索，理解用户意图而非仅仅关键词匹配
- **个性化推荐**: 根据用户询问的心情、类型等提供定制化推荐
- **相关内容发现**: 自动展示与当前话题相关的其他内容
- **上下文理解**: 能够理解对话上下文，提供连贯的对话体验
- **多维度检索**: 支持跨类型（书籍、电影、音乐）的综合搜索

### 详情弹窗系统

- **内容展示**: 书籍、电影、音乐的详细信息
- **学校信息弹窗**: 教育背景详细展示 (新增)
- **二维码弹窗**: 微信和公众号二维码展示 (新增)
- **背景毛玻璃**: 优雅的视觉效果
- **响应式设计**: 适配各种屏幕尺寸
- **交互动画**: 平滑的打开/关闭效果
...
- **动态背景选择**: 基于时间戳的智能背景切换 (新增)
- **多套背景图**: 每个页面3张不同背景图循环 (新增)
- **淡入淡出效果**: 优雅的背景切换动画 (优化)
- **会话一致性**: 整个会话期间保持相同背景组合 (新增)
- **页面适配**: 不同页面的主题背景
...
### 阶段7: 背景系统升级和扩展功能 (最新完成)

- **动态背景管理系统**: 基于时间戳的智能背景选择
- **多套背景图片**: 每个页面增加到3张背景图
- **淡入淡出优化**: 修复背景切换的视觉效果
- **学校信息弹窗**: 教育背景点击查看详细校园体验
...
- ✅ 核心功能完整实现
- ✅ 响应式设计完善
- ❌ **详情展示系统存在问题** - Details弹窗API异常 🚨
- ✅ 背景系统全面升级
- ✅ 学校信息和二维码功能完整
- ✅ 交互功能齐全
- ✅ **RAG智能问答系统完整集成** 🆕
- ✅ **AI驱动的个性化体验** 🆕
- ✅ **数据库迁移完成** - PostgreSQL统一架构 🆕
- 🔄 **待修复**: Details弹窗API端点500错误问题

#### 🚨 当前已知问题
详细问题记录和修复状态请查看: [`CURRENT-ISSUES-README.md`](../CURRENT-ISSUES-README.md)
